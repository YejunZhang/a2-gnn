...
from a2gnn.utils.evaluator import MatcherEvaluator, summarize_metrics
from a2gnn.utils.logger import get_logger

logger = get_logger(level="INFO", name="a2gnn_eval")
...
def run_benchmark(
    ...
    data_loader = init_data_loader(config, split=split, batch = 16)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--p2d_type", type=str, choices=["sift", "superpoint", "r2d2"], default="sift"
    )
