...
class SelfAttention(nn.Module):
    def __init__(self, feature_dim: int, k: int = 10, in_channel: int = 128) -> None:
        ...
        #         nn.Conv2d(self.in_channel*2, self.in_channel, (1, nodes), stride=(1, nodes)),
        #         nn.InstanceNorm2d(self.in_channel),
        #         nn.ReLU(inplace=True),
        #         nn.Conv2d(self.in_channel, self.in_channel, (1, s)),
        #         nn.InstanceNorm2d(self.in_channel),
        #         nn.ReLU(inplace=True),
        #     )
        self.annuconv1 = nn.Sequential(
        ...
        #         nn.Conv2d(1, self.in_channel, (1, nodes), stride=(1, nodes)),
        #         nn.InstanceNorm2d(self.in_channel),
        #         nn.ReLU(inplace=True),
        #         nn.Conv2d(self.in_channel, self.in_channel, (1, s)),
        #         nn.InstanceNorm2d(self.in_channel),
