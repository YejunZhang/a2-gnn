...
class OTMatcher(nn.Module):
    def __init__(
        ...
        # 2D encoder
        self.kp2d_enc = PointResNetEncoder(in_channel=2, feat_channel=kp_feat_dim,num_layers=12)
...
class OTMatcherCls(nn.Module):
    ...
    def forward(
        ...
        # print("enoderX16:", time.time() - encoder_time)
